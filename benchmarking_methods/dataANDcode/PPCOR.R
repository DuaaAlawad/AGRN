...
mydata <- read.table('/home/dmalawad/Research/AGRN_tool/benchmarking_methods/data/DREAM5/net4_exp.csv', sep = ",", header = FALSE, row.names = 1) 
...
write.table(outDF, '/home/dmalawad/Research/AGRN_tool/benchmarking_methods/infer_net4.tsv', sep = "\t", quote = FALSE, row.names = FALSE)
